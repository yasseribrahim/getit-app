...
public class ExamDetailsActivity extends BaseActivity implements UsersCallback, View.OnClickListener {
    ...
    private AnswerStudent currentAnswerStudent;
...
//        currentAnswerStudent = currentUser.getExamStudent(lesson);
        bind();
...
//                bindQuestion();
        ...
        binding.btnFinish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                currentAnswerStudent.setFinished(true);
...
//        currentAnswer = currentUser.getAnswer(currentAnswerStudent, currentOldQuestion);
